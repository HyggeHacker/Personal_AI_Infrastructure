# PAI Modes — Response Formatting Rules

Loaded at session start ONLY when `PAI_ACTIVE=1` (launched via `pai` alias). Vanilla `claude` never sees this.
...
🗣️ JAM: [summary in 8-16 word summary]
```
